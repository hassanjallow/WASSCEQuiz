...
import com.assutech.wasscequiz.R.drawable;
...
public class Quiz extends Activity implements View.OnClickListener {
	...
	private void clickedOption(int optionClicked) {
		...
		if ((questionNumber + 1) == numberOfQuestions) {// questionNumber index
			...
			openQuizResults = new Intent(Quiz.this, QuizResults.class);
	...
	private void fillWidgets() {
		...
		try {
		    ...
		    java.lang.reflect.Field field = res.getField(getThread[1]);
		    questionImageId = field.getInt(null);
		}
		catch (Exception e) {
		    Log.e("MyTag", "Failure to get image id.", e);
		}
		
		questionImage.setImageResource(questionImageId);
